...
func (*ExternalMetricValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_138552c0e3b59a5a, []int{0}
}
...
func (dst *ExternalMetricValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExternalMetricValue.Merge(dst, src)
}
...
func (*ExternalMetricValueList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_138552c0e3b59a5a, []int{1}
}
...
func (dst *ExternalMetricValueList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExternalMetricValueList.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/metrics/pkg/apis/external_metrics/v1beta1/generated.proto", fileDescriptor_generated_138552c0e3b59a5a)
}

var fileDescriptor_generated_138552c0e3b59a5a = []byte{

...
func (*ContainerMetrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_450d8927781e7187, []int{0}
}
...
func (dst *ContainerMetrics) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContainerMetrics.Merge(dst, src)
}
...
func (*NodeMetrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_450d8927781e7187, []int{1}
}
...
func (dst *NodeMetrics) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeMetrics.Merge(dst, src)
}
...
func (*NodeMetricsList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_450d8927781e7187, []int{2}
}
...
func (dst *NodeMetricsList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NodeMetricsList.Merge(dst, src)
}
...
func (*PodMetrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_450d8927781e7187, []int{3}
}
...
func (dst *PodMetrics) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PodMetrics.Merge(dst, src)
}
...
func (*PodMetricsList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_450d8927781e7187, []int{4}
}
...
func (dst *PodMetricsList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PodMetricsList.Merge(dst, src)
}
...
func (m *ContainerMetrics) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Usage) > 0 {
		...
		for _, k := range keysForUsage {
			...
			msgSize := 0
			if ((*resource.Quantity)(&v)) != nil {
				msgSize = ((*resource.Quantity)(&v)).Size()
			...
			dAtA[i] = 0x12
			i++
			i = encodeVarintGenerated(dAtA, i, uint64(((*resource.Quantity)(&v)).Size()))
			n1, err := ((*resource.Quantity)(&v)).MarshalTo(dAtA[i:])
			if err != nil {
				return 0, err
			}
			i += n1
...
func (m *NodeMetrics) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Usage) > 0 {
		...
		for _, k := range keysForUsage {
			...
			i++
			i = encodeVarintGenerated(dAtA, i, uint64(((*resource.Quantity)(&v)).Size()))
			n5, err := ((*resource.Quantity)(&v)).MarshalTo(dAtA[i:])
			if err != nil {
				return 0, err
			}
			i += n5
...
func (this *NodeMetrics) String() string {
	...
	s := strings.Join([]string{`&NodeMetrics{`,
		...
		`Timestamp:` + strings.Replace(strings.Replace(this.Timestamp.String(), "Time", "v1.Time", 1), `&`, ``, 1) + `,`,
		`Window:` + strings.Replace(strings.Replace(this.Window.String(), "Duration", "v1.Duration", 1), `&`, ``, 1) + `,`,
		`Usage:` + mapStringForUsage + `,`,
		`}`,
	}, "")
	return s
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/metrics/pkg/apis/metrics/v1alpha1/generated.proto", fileDescriptor_generated_450d8927781e7187)
}

var fileDescriptor_generated_450d8927781e7187 = []byte{

...
func (*MetricListOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_c30bc3144f324de0, []int{0}
}
...
func (*MetricValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_c30bc3144f324de0, []int{1}
}
...
func (*MetricValueList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_c30bc3144f324de0, []int{2}
}
...
func (this *MetricValue) String() string {
	...
	s := strings.Join([]string{`&MetricValue{`,
		`DescribedObject:` + strings.Replace(strings.Replace(this.DescribedObject.String(), "ObjectReference", "v1.ObjectReference", 1), `&`, ``, 1) + `,`,
		`MetricName:` + fmt.Sprintf("%v", this.MetricName) + `,`,
		`Timestamp:` + strings.Replace(strings.Replace(this.Timestamp.String(), "Time", "v11.Time", 1), `&`, ``, 1) + `,`,
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/metrics/pkg/apis/custom_metrics/v1beta1/generated.proto", fileDescriptor_generated_c30bc3144f324de0)
}

var fileDescriptor_generated_c30bc3144f324de0 = []byte{

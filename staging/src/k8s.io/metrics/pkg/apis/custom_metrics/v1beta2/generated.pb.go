...
func (*MetricIdentifier) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_5b610d78a98f840d, []int{0}
}
...
func (*MetricListOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_5b610d78a98f840d, []int{1}
}
...
func (dst *MetricListOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetricListOptions.Merge(dst, src)
}
...
func (*MetricValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_5b610d78a98f840d, []int{2}
}
...
func (*MetricValueList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_5b610d78a98f840d, []int{3}
}
...
func (dst *MetricValueList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetricValueList.Merge(dst, src)
}
...
func (this *MetricValue) String() string {
	...
	s := strings.Join([]string{`&MetricValue{`,
		`DescribedObject:` + strings.Replace(strings.Replace(this.DescribedObject.String(), "ObjectReference", "v11.ObjectReference", 1), `&`, ``, 1) + `,`,
		...
		`Value:` + strings.Replace(strings.Replace(this.Value.String(), "Quantity", "resource.Quantity", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/metrics/pkg/apis/custom_metrics/v1beta2/generated.proto", fileDescriptor_generated_5b610d78a98f840d)
}

var fileDescriptor_generated_5b610d78a98f840d = []byte{

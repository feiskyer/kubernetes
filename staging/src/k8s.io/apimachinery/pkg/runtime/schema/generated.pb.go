...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/apimachinery/pkg/runtime/schema/generated.proto", fileDescriptor_generated_49ef51acb38b824b)
}

var fileDescriptor_generated_49ef51acb38b824b = []byte{

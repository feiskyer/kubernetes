...
func (*AdmissionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_ced6c3f1a5585a6c, []int{0}
}
...
func (*AdmissionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_ced6c3f1a5585a6c, []int{1}
}
...
func (*AdmissionReview) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_ced6c3f1a5585a6c, []int{2}
}
...
func (this *AdmissionRequest) String() string {
	...
	s := strings.Join([]string{`&AdmissionRequest{`,
		...
		`Kind:` + strings.Replace(strings.Replace(this.Kind.String(), "GroupVersionKind", "v1.GroupVersionKind", 1), `&`, ``, 1) + `,`,
		`Resource:` + strings.Replace(strings.Replace(this.Resource.String(), "GroupVersionResource", "v1.GroupVersionResource", 1), `&`, ``, 1) + `,`,
		`SubResource:` + fmt.Sprintf("%v", this.SubResource) + `,`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Namespace:` + fmt.Sprintf("%v", this.Namespace) + `,`,
		`Operation:` + fmt.Sprintf("%v", this.Operation) + `,`,
		`UserInfo:` + strings.Replace(strings.Replace(this.UserInfo.String(), "UserInfo", "v11.UserInfo", 1), `&`, ``, 1) + `,`,
		`Object:` + strings.Replace(strings.Replace(this.Object.String(), "RawExtension", "runtime.RawExtension", 1), `&`, ``, 1) + `,`,
		`OldObject:` + strings.Replace(strings.Replace(this.OldObject.String(), "RawExtension", "runtime.RawExtension", 1), `&`, ``, 1) + `,`,
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/admission/v1beta1/generated.proto", fileDescriptor_generated_ced6c3f1a5585a6c)
}

var fileDescriptor_generated_ced6c3f1a5585a6c = []byte{

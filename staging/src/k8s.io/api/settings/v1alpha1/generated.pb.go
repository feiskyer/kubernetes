...
func (*PodPreset) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_564093395742f621, []int{0}
}
...
func (*PodPresetList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_564093395742f621, []int{1}
}
...
func (*PodPresetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_564093395742f621, []int{2}
}
...
func (this *PodPresetSpec) String() string {
	...
	s := strings.Join([]string{`&PodPresetSpec{`,
		`Selector:` + strings.Replace(strings.Replace(this.Selector.String(), "LabelSelector", "v1.LabelSelector", 1), `&`, ``, 1) + `,`,
		`Env:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Env), "EnvVar", "v11.EnvVar", 1), `&`, ``, 1) + `,`,
		`EnvFrom:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.EnvFrom), "EnvFromSource", "v11.EnvFromSource", 1), `&`, ``, 1) + `,`,
		`Volumes:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Volumes), "Volume", "v11.Volume", 1), `&`, ``, 1) + `,`,
		`VolumeMounts:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.VolumeMounts), "VolumeMount", "v11.VolumeMount", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/settings/v1alpha1/generated.proto", fileDescriptor_generated_564093395742f621)
}

var fileDescriptor_generated_564093395742f621 = []byte{

...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_d798b1ed4a515e4f, []int{0}
}
...
func (*EventList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_d798b1ed4a515e4f, []int{1}
}
...
func (*EventSeries) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_d798b1ed4a515e4f, []int{2}
}
...
func (this *Event) String() string {
	...
	s := strings.Join([]string{`&Event{`,
		...
		`Regarding:` + strings.Replace(strings.Replace(this.Regarding.String(), "ObjectReference", "v11.ObjectReference", 1), `&`, ``, 1) + `,`,
		...
		`DeprecatedSource:` + strings.Replace(strings.Replace(this.DeprecatedSource.String(), "EventSource", "v11.EventSource", 1), `&`, ``, 1) + `,`,
		`DeprecatedFirstTimestamp:` + strings.Replace(strings.Replace(this.DeprecatedFirstTimestamp.String(), "Time", "v1.Time", 1), `&`, ``, 1) + `,`,
		`DeprecatedLastTimestamp:` + strings.Replace(strings.Replace(this.DeprecatedLastTimestamp.String(), "Time", "v1.Time", 1), `&`, ``, 1) + `,`,
...
func (this *EventSeries) String() string {
	...
	s := strings.Join([]string{`&EventSeries{`,
		...
		`LastObservedTime:` + strings.Replace(strings.Replace(this.LastObservedTime.String(), "MicroTime", "v1.MicroTime", 1), `&`, ``, 1) + `,`,
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/events/v1beta1/generated.proto", fileDescriptor_generated_d798b1ed4a515e4f)
}

var fileDescriptor_generated_d798b1ed4a515e4f = []byte{

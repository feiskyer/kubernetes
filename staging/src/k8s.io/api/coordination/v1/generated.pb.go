...
func (*Lease) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_42f512938bface36, []int{0}
}
...
func (*LeaseList) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_42f512938bface36, []int{1}
}
...
func (*LeaseSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_generated_42f512938bface36, []int{2}
}
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/coordination/v1/generated.proto", fileDescriptor_generated_42f512938bface36)
}

var fileDescriptor_generated_42f512938bface36 = []byte{
